...
//const user = { name: 'John'; } cons

//const user = { name: 'John', toString() 
...
//console.log("User: " + user); 
 // User: [object Object] 
 // const user = { name: 'John', toString()
 //  { return this.name; // custom string value } } c

 //const apple = { name: 'Apple', category: 'Granny Smith', price: 1.2, valueOf()
 //    { // without this special function, we can’t multiply the object below return this.price; } } console.log(apple * 2) // 2.4
...
//console.log("User: " + user);
//console.log(`welcome, '$(user)`); //welcome, object object
...
// const apple = {// The value of the apple is 1.2.Changed throught the below context.
// name: 'Apple',
// category: 'Granny Smith',
// price: 1.2,
// valueOf() { //always make sure the O is capitalized. without this special function, we can’t multiply the object below
// return this.price;//apple is always going to return the value of 1.2
// }
// }

// console.log(apple * 2) // 2.4 calculates the price
...
// console.log(isNaN(NaN)) // true. It is equal to itself.
// console.log(NaN == NaN) // false. This goes into a zero, so automatically false.
...
// console.log(fruits); // [ 'Apple', 'Orange' ] Pear is already extracted.
...
// const removed = spliceArray.splice(0, 3, "Let's", "dance")//removed is the constant that uses splice array to remove.

// console.log(removed) // [ 'I', 'study', 'JavaScript' ] - 3 elements starting at index 0 are removed. Removed holds the removed elements.
...
// }
// // Example usage
// console.log('#1: ' + getCachedData(3)); // First time: fetches "external" data and caches result
// console.log('#2: ' + getCachedData(3)); // Other times: can fetch result from cache, much faster
