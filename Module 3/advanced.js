...
// }
// }
// setTimeout( function() { user.sayHi(); }, 1000 ) // works! Hi, John. Just removing function and curly brackets
...
//  (`${prop} is ${rabbit1[prop]}`) // own properties, then inherited ones
...
// };
// }
// console.log( "La".repeat(3) ); // LaLaLalet animal = { eats: true, sleeps: true, legs: 4, mammal: true }; // inherits from Object prototype
...
// for (let prop in rabbit1) console.log
