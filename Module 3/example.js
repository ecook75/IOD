//console.log('hello');
//console.log('world');//this is a comment
//console.log("not a number" /1); //invalid comment
...
console.log(tv.brand/model); // logs the whole object
...
//`console.log(`is ${one} greater than ${two}?`)//
...
//onsole.log( Number(" 4 ") ) // 4 - trims spaces
...
//if ("true") console.log('empty string is true') // implicit "" conversion to false - won't print msg
